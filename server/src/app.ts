...
import { usageLimitsRouter } from './routes/usage-limits.js';
...
export function createApp(config?: Config) {
  ...
  app.use('/api/proxies', requireAuth, proxiesRouter);
  ...
  app.use('/api/usage-limits', requireAuth, usageLimitsRouter);
